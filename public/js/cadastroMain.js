  ...
  $checkBox.addEventListener("change", function(){
    if($checkBox.checked == true){
      document.getElementById("imgPerfil").src="../img/cadastro/woman.gif";
    }
  })
  ...
  $checkBox1.addEventListener("change", function(){
    if($checkBox1.checked == true){
      document.getElementById("imgPerfil").src="../img/cadastro/man.gif";
    }
  })
  ...
  $checkBox3.addEventListener("change", function(){
    if($checkBox3.checked == true){
      document.getElementById("imgPerfil").src="../img/cadastro/other.png";
    }
  })
  ...
  $checkBoxPet.addEventListener("change", function(){
    if($checkBoxPet.checked == true){ 
      document.getElementById("imgP").src="../img/cadastro/catCard.gif";
  ...
  $checkBoxPet2.addEventListener("change", function(){
    if($checkBoxPet2.checked == true){
      document.getElementById("imgP").src="../img/cadastro/dogCard.gif";
  ...
  $checkBoxPet3.addEventListener("change", function(){
    if($checkBoxPet3.checked == true){
      document.getElementById("imgP").src="../img/cadastro/bunnyCard.gif";
      var ccRaca = document.querySelector(".cc-raca .value")
